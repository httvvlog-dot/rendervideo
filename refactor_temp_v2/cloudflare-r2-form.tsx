...
export function CloudflareR2Form({ providerId, credential, onSuccess }: { providerId: string, credential?: any, onSuccess: () => void }) {
  ...
  return (
    <form onSubmit={handleSave} className="space-y-5">
      <div>
        <label className="block text-sm font-medium mb-1">Configuration Name <span className="text-red-500">*</span></label>
        <input 
          type="text" 
          name="credential_name" 
          defaultValue={credential?.credential_name}
          required
          placeholder="e.g. Bucket VN Production"
      ...
      <div className="border-t pt-4 space-y-4">
        <div>
          ...
          <input 
            ...
            required
            className="w-full border rounded-lg px-3 py-2 bg-slate-50 dark:bg-slate-800 outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm"
          />
        </div>
