...
-- Insert Pricing
INSERT INTO public.provider_model_pricing (provider, model, api_cost, input_cost, output_cost, currency, pricing_type, version, unit)
VALUES 
  ('openrouter', 'deepseek/deepseek-v4-flash', 0.0001, 0, 0, 'USD', 'per_unit', 1, '1M tokens'),
  ('openrouter', 'openai/gpt-4o-mini', 0.0001, 0, 0, 'USD', 'per_unit', 1, '1M tokens'),
  ('elevenlabs', 'eleven_multilingual_v2', 0.03, 0, 0, 'USD', 'per_unit', 1, '1M tokens')
