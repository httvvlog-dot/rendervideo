...
replaceInFile('utils/provider-runtime/retry-engine.ts', [
    ...
    {
        search: /const isRetryable = status === "rate_limited" \|\| status === "timeout" \|\| status === "warning";\s*const willRetry = attempts <= maxRetries && isRetryable && status !== "offline";/m,
...
replaceInFile('utils/provider-runtime/credential-selector.ts', [
    ...
    {
        search: /c\.health_status !== "offline"/g,
